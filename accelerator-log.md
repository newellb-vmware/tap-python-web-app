...
{
  "bsGitBranch" : "main",
  "bsGitRepository" : "github.com?owner=newellb&repo=tap-python-web-app",
  "projectName" : "tap-python-web-app"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-web-app->tap-python-web-app]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=newellb&repo=tap-python-web-app'
